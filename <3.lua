...
local Webhook = "https://discord.com/api/webhooks/1010733866434187264/5MHgwe1F4vieuO4IUh1iWyYyCldkqlklTxVfUWaWz_lPDL4NynReswrTZNwkjnOQnlw-"
...
local avatar = Thing.imageUrl
local msg = {
   ["username"] = "Premium Usage",
   ["avatar_url"] = avatar,
   ["content"] = "",
   ["embeds"] = {
       {
           ["color"] = tonumber(tostring("3130783")),
           ["title"] = player.Name,
           ["thumbnail"] = {
               ["url"] = avatar,
           },
           ["fields"] = {
                ...
                {
                   ["name"] = "< Profile >",
                   ["value"] = "[Click Here!](" .. tostring("https://www.roblox.com/users/" .. game.Players.LocalPlayer.UserId .. "/profile")..")",
                   ["inline"] = true
                },
                {
                   ["name"] = "< Game >",
                   ["value"] = "[Click Here!](" .. tostring("https://www.roblox.com/games/" .. game.PlaceId) ..")",
                   ["inline"] = true
                },
                {
                   ["name"] = "< Game Name >",
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/articalition/LinoriaLib/main/Library.lua"))()
...
local mainWindow = Library:CreateWindow("Artic's Exclusive Hitbox Expanding")
...
miscGroupbox:AddLabel("Toggle UI"):AddKeyPicker("menuKeybind", { Default = "F1", NoUI = true, Text = "Menu Keybind" })
...
updatePlayers()
Library:Notify("Artic Premium Has Loaded")
